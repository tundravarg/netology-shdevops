...
NOTE: В каталоге `ansible-ssh` - вариант развёртывания стенда, где Ansible Control Node и Managed Nodes разворачиваются каждый в своём контейнере и Ansible взаимодействует с ними посредством SSH.

TODO: Настроить стенд "по заданию"
